...
class HttpGetReader extends Readable {
  ...
  constructor (url, options = undefined) {
    ...
    this._onRequestCloseHandler = (...args) => this._onRequestClose(...args)
    ...
    this._onTransformCloseHandler = (...args) => this._onTransformClose(...args)
  ...
  _startRequest () {
    ...
    this._request
      ...
      .on('close', this._onRequestCloseHandler)
    ...
    if (_.isBoolean(shouldProcessData) && shouldProcessData) {
      ...
      if (this._options.transform) {
        this._options.transform
          ...
          .on('close', this._onTransformCloseHandler)
  ...
  _detachFromStreams () {
    ...
    if (this._request) {
      ...
      this._request.removeListener('close', this._onRequestCloseHandler)
    ...
    if (this._options.transform) {
      this._options.transform.removeListener('data', this._onTransformDataHandler)
      this._options.transform.removeListener('error', this._onTransformErrorHandler)
      this._options.transform.removeListener('close', this._onTransformCloseHandler)
      this._options.transform.removeListener('end', this._onTransformEndHandler)
